...
public abstract class CommandMaster {
    protected net.zoizoi.plugin.drownair.core.command.CommandManager manager;

    public CommandMaster(net.zoizoi.plugin.drownair.core.command.CommandManager manager) {
